# ================================================================
# openEMS MSL PORT VALIDATION V2
#
# Purpose:
...
XML_FILE = SIM_DIR / "msl_validation_v2.xml"
CSV_FILE = RESULTS_DIR / "msl_validation_v2.csv"
PLOT_FILE = RESULTS_DIR / "msl_validation_v2.png"
...
print("=" * 72)
print("openEMS MSL PORT VALIDATION V2")
print("=" * 72)
...
print(
    f"Port 1 |Z_ref|    : "
    f"{abs(Zref1[idx]):.3f} ohm"
)

print(
    f"Port 2 |Z_ref|    : "
    f"{abs(Zref2[idx]):.3f} ohm"
)
