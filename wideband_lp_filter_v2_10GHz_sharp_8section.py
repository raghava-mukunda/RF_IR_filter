...
RUN_ID = os.environ.get("WB_RUN_ID", "wideband_lp_filter_v2_10GHz_sharp_8section")
...
A = float(os.environ.get("WB_A", "5.00"))
B = float(os.environ.get("WB_B", "5.00"))
D = float(os.environ.get("WB_D", "5.05"))
...
N_SECTIONS = int(os.environ.get("WB_NSECTIONS", "8"))
...
RING_SPACING = float(os.environ.get("WB_RING", "4.50"))
SECTION_PITCH = float(os.environ.get("WB_PITCH", "9.00"))
...
print()
print("=" * 100)
print("Wideband LP Filter LEAKY COAX — V2 10-GHz SHARP CUTOFF")
print("=" * 100)
print("V2 redesign: 10-GHz resonant aperture coupling + 8 leakage sections:")
...
print()
print("NOTE: V2 FULL-WIDTH SCREENING MODE")
