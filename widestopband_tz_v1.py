...
F_START = 1.0e9
F_STOP = 100.0e9
# 1001 points are sufficient for V1 screening.
N_FREQ = 1001
...
# Fast first-pass transient.
NR_TS = 60000
# Relaxed for V1; tighten for final validation.
END_CRITERIA = 1e-4

# FAST V1 mesh: sufficient for topology validation.
# Final convergence runs will use 0.15 mm and 0.10 mm.
GRID = 0.25
...
if estimated_cells > 15_000_000:
    raise RuntimeError(
        f"V1 mesh is still too large ({estimated_cells:,} cells). "
        "Reduce GRID before launching openEMS."
    )
...
print()
print("NOTE: FAST V1 MODE")
print("      0.25 mm Cartesian mesh / 60k maximum timesteps / 1–100 GHz.")
print("      This run is for topology validation, not final mesh convergence.")
print("      If V1 looks correct, repeat at 0.15 mm and 0.10 mm.")
print()
...
metrics = {
    ...
    "simulation_mode": "FAST_V1_TOPOLOGY_VALIDATION",
}
